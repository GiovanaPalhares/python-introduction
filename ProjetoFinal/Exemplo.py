...
def avalia_textos(textos, ass_cp):
    ...
    grau_similaridade = compara_assinatura(assinatura_texto,
                                           ass_cp)  # verifica o grau de similaridade do primeiro texto com a assinatura do aluno
